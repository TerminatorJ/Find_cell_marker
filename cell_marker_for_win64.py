...
app_dir=pj(os.getcwd(),"cell_marker_app")
need_file_dir=pj(app_dir,"need_file")

marker_file=need_file_dir+"//marker_sheet.xlsx"
cluster_marker_file=need_file_dir+"//all_conserved_markers.xlsx"
pub_db_file=need_file_dir+"//cellmarekerDB_new.xlsx"
########################################################################################################
